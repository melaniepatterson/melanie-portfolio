...
// Desktop-only decorative accent, top-left — gets the same cursor-repulsion
// motion as Home's stars (see Radialgradient.jsx / utils.jsx). Positioned
// so its top points sit above the viewport and get cropped off.
const StarLeft = forwardRef((props, ref) => (
  <svg
    ref={ref}
...
// Desktop-only decorative accent, bottom edge — static, no motion.
// Positioned so it pokes just slightly (~5% of its own height) past the
// bottom of the viewport.
const StarBottom = forwardRef((props, ref) => (
  <svg
    ref={ref}
    xmlns="http://www.w3.org/2000/svg"
...
export default function AboutContact() {
  ...
  // StarLeft's cursor-repulsion motion — desktop only, same physics as
  // Home's stars (Radialgradient.jsx), just driving one element instead
  // of four. Mobile placement/treatment for both new stars is a
  // follow-up; for now they're desktop-only.
  useEffect(() => {
    if (isMobile) return;
