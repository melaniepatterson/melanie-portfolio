...
const products = [
  { id: 'pr-cleanser', name: 'Glucoside Foaming Cleanser', brand: 'The Ordinary', category: 'cleanser', image_url: 'https://brcjhshptisevcndqavz.supabase.co/storage/v1/object/public/product-images/rdn-glucoside-foaming-cleanser-150ml.webp', purchase_url: 'https://example.com', bds_compliant: true, effectiveness_avg: 4.5, tags: ['fragrance-free'], notes: '', ingredient_category: '', ingredient_form: '', is_catalog: true, user_id: null },
  { id: 'pr-tret', name: 'Adapalene Gel 0.1%', brand: 'Differin', category: 'active', image_url: 'https://brcjhshptisevcndqavz.supabase.co/storage/v1/object/public/product-images/differin-0.1-GEL15GTube-Carton.webp', purchase_url: 'https://example.com', bds_compliant: true, effectiveness_avg: 4.8, tags: [], notes: '', ingredient_category: 'retinoid', ingredient_form: 'gel', is_catalog: true, user_id: null },
  { id: 'pr-moisturizer', name: 'Midnight Blue Calming Cream', brand: 'Klairs', category: 'moisturizer', image_url: 'https://brcjhshptisevcndqavz.supabase.co/storage/v1/object/public/product-images/Midnight-Blue-Calming-Cream_60g600x700-PD.jpg', purchase_url: 'https://example.com', bds_compliant: true, effectiveness_avg: 4.6, tags: ['barrier-repair'], notes: '', ingredient_category: '', ingredient_form: '', is_catalog: true, user_id: null },
  { id: 'pr-spf', name: 'Black Girl Sunscreen SPF 30', brand: 'Black Girl Sunscreen', category: 'spf', image_url: 'https://brcjhshptisevcndqavz.supabase.co/storage/v1/object/public/product-images/bgs-spf30.webp', purchase_url: 'https://example.com', bds_compliant: true, effectiveness_avg: 4.4, tags: [], notes: '', ingredient_category: '', ingredient_form: '', is_catalog: true, user_id: null },
  { id: 'pr-vitc', name: 'Ascorbyl Glucoside Solution 12%', brand: 'The Ordinary', category: 'serum', image_url: 'https://brcjhshptisevcndqavz.supabase.co/storage/v1/object/public/product-images/rdn-ascorbyl-glucoside-solution-12pct-30ml.webp', purchase_url: 'https://example.com', bds_compliant: true, effectiveness_avg: 4.7, tags: ['vitamin-c'], notes: '', ingredient_category: 'antioxidant', ingredient_form: 'serum', is_catalog: true, user_id: null },
  ...
  { id: 'pr-toner', name: 'Heartleaf 77% Soothing Toner', brand: 'Anua', category: 'toner', image_url: 'https://brcjhshptisevcndqavz.supabase.co/storage/v1/object/public/product-images/anua-us-toner-heartleaf-77-soothing-toner-1239193744.webp', purchase_url: 'https://example.com', bds_compliant: true, effectiveness_avg: 4.0, tags: [], notes: '', ingredient_category: '', ingredient_form: '', is_catalog: true, user_id: null },
  { id: 'pr-eye', name: 'Caffeine Solution 5% + EGCG', brand: 'The Ordinary', category: 'eye_cream', image_url: 'https://brcjhshptisevcndqavz.supabase.co/storage/v1/object/public/product-images/ORD-Product-Box-Caff-Sol-5pct-ECCG-Eye-Serum.webp', purchase_url: 'https://example.com', bds_compliant: true, effectiveness_avg: 4.3, tags: [], notes: '', ingredient_category: '', ingredient_form: '', is_catalog: true, user_id: null },
  ...
  { id: 'pr-oil', name: '100% Plant-Derived Squalane', brand: 'The Ordinary', category: 'facial_oil', image_url: 'https://brcjhshptisevcndqavz.supabase.co/storage/v1/object/public/product-images/rdn-100pct-plant-derived-squalane-30ml.webp', purchase_url: 'https://example.com', bds_compliant: true, effectiveness_avg: 4.4, tags: [], notes: '', ingredient_category: '', ingredient_form: '', is_catalog: true, user_id: null },
  { id: 'pr-mask', name: 'Watermelon Glow PHA+BHA Pore-Tight Toner', brand: 'Glow Recipe', category: 'toner', image_url: 'https://brcjhshptisevcndqavz.supabase.co/storage/v1/object/public/product-images/PDP_IMAGES_Watermelon-Glow-PHA_BHA-Pore-Tight-Toner-5_8726c95e-05a9-4c53-af63-80a8b9926ae7.webp', purchase_url: 'https://example.com', bds_compliant: true, effectiveness_avg: 4.0, tags: ['weekly'], notes: '', ingredient_category: '', ingredient_form: '', is_catalog: true, user_id: null },
  { id: 'pr-lip', name: 'Hydro-Stars Acne Patches', brand: 'Starface', category: 'spot_treatment', image_url: 'https://brcjhshptisevcndqavz.supabase.co/storage/v1/object/public/product-images/Starface-Hydro-Star-Salicylic-Acid-Patches-Big-Blue-Compact-32ct_4dee4b16-3c5a-42da-b329-4ba43ae710b9.0861787b421536a013dd691215dcaefe.avif', purchase_url: 'https://example.com', bds_compliant: true, effectiveness_avg: 4.6, tags: [], notes: '', ingredient_category: '', ingredient_form: '', is_catalog: true, user_id: null },
]
...
const routine_periods = [
  {
    ...
    active_name: 'adapalene', tret_enabled: true, tret_frequency: 2, tret_start_date: daysAgo(19),
