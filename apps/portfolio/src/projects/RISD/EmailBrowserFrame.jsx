...
export default function EmailBrowserFrame({ src }) {
  return (
    ...
    >
      ...
      {/* Flat page-red chrome, no mix-blend-mode: this frame sits over a
          photo (not a light screenshot), so multiply would darken/tint
          against the photo's own color instead of reading as the page's
          own background peeking through. */}
      <g>
