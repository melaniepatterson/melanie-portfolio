...
const StarLeft = forwardRef(({ style, isMobile }, ref) => (
  <div
    style={{
      position: "fixed",
      pointerEvents: "none",
  ...
  >
    <svg
      ...
      aria-hidden="true"
      // will-change only actually earns its keep on desktop, where the
      // cursor-repulsion effect below drives real transform updates on
      // mousemove — on mobile these stars are static (that effect bails
      // immediately, see isMobile check), so the hint just forces an
      // unnecessary GPU compositing layer. This page already stacks
      // three of these plus a fixed nav and the sitewide animated grain
      // overlay; that many composited layers together is the same class
      // of Safari scroll-repaint bug already found and fixed elsewhere
      // this session, just from a different trigger.
      style={{ display: "block", width: "100%", height: "100%", fill: "#ffd6f9", willChange: isMobile ? undefined : "transform" }}
    >
...
const StarBottom = forwardRef(({ style, isMobile }, ref) => (
  <div
    style={{
      position: "fixed",
      pointerEvents: "none",
  ...
  >
    <svg
      ...
      aria-hidden="true"
      // See StarLeft above — will-change only earns its keep on desktop.
      style={{ display: "block", width: "100%", height: "100%", fill: "#ffd6f9", willChange: isMobile ? undefined : "transform" }}
    >
  ...
  return (
    <div className={styles.page}>
      <StarLeft
        ...
        isMobile={isMobile}
        style={isMobile
          // Fixed, same as desktop below — an absolute, negative-z-index
          // layer scrolling alongside the normal-flow text around it was
          // part of what made this page prone to Safari repaint/ghosting
          // artifacts during fast scroll. Fixed removes it from the
      ...
      <StarBottom
        ...
        isMobile={isMobile}
        style={isMobile
          // Fixed, bottom-anchored — see StarLeft above.
