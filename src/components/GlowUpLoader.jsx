  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{ fontSize: 28, fontWeight: 800, letterSpacing: '-0.04em', color: '#1A1A1A', lineHeight: 1,  }}>Glow <span style={{ color: '#C93500' }}>Up</span><span style={{ color: '#FFD6F9' }}>.</span></span>
      </div>
