import { ACTIVE_STEP_KEYS } from './programOptions'
...
export default function ProgramOptionsChecklist({ options, selected, onToggle }) {
  ...
  return (
    <>
      {realOptions.map(opt => {
        ...
        return (
          <button key={opt.id} onClick={() => !disabledByOtherActive && onToggle(opt)}
