...
// Color values match apps/glowup/src/theme.js (T.white, T.textMuted, T.text,
// T.darkGreen, T.radius.pill) — inlined rather than imported so this shared
// component doesn't pull GlowUp's whole design-token module into the
// portfolio's bundle.
const COPY = {
  glowup: {
